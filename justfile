...
generate-abi: build-contracts
	...
	jq '.abi' out/AlloOFTUpgradeable.sol/AlloOFTUpgradeable.json > abi/AlloOFTUpgradeable.json
	...
	abigen --abi abi/AlloOFTUpgradeable.json --pkg allooftupgradeable --type Contract --out packages/go-abigen/allooftupgradeable/contract.go
